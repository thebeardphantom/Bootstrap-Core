...
namespace BeardPhantom.Bootstrap
{
    ...
    internal sealed class PriorityQueueDebugView<TElement, TPriority>
    {
        ...
        {
            ArgumentNullExceptionUtility.ThrowIfNull(queue);
    ...
    internal static class ArgumentNullExceptionUtility
    {
    ...
    public class PriorityQueue<TElement, TPriority>
    {
        ...
        /// <exception cref="ArgumentNullExceptionUtility">
        ...
        {
            ArgumentNullExceptionUtility.ThrowIfNull(items);
        ...
        {
            ArgumentNullExceptionUtility.ThrowIfNull(elements);
            ...
            ICollection
        {
            ...
            {
                ArgumentNullExceptionUtility.ThrowIfNull(array);
